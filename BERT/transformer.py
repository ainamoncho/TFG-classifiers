...
model_name = 'saved_bert_model_task1'
...
# Loading the model
model2 = BertForSequenceClassification.from_pretrained('bert-base-multilingual-cased', num_labels=6)
...
# Save the model and tokenizer
model_name = 'saved_bert_model_task2'
